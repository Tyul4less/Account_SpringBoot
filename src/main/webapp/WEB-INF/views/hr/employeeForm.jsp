...
<head>
    ...
    <script>
        ...
        function showEmployeeList() {
            ...
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/hr/findEmployeeList",
                data:{
...
//                     console.log(jsonObj.detailCodeList);
                    $(deptListGrid).jqGrid('setGridParam', {data: jsonObj});
                    // hide the show message
        ...
        function addEmployeeFunc(){
        	location.href = "${pageContext.request.contextPath}/hr/empinsertForm.html";
        }
        
        function deleteEmployeeFunc(){
        	$.ajax({
        		url : "${pageContext.request.contextPath}/hr/deleteEmployee",
        		data : {
