...
<head>
    ...
    <script>
        ...
        function showTotalTrialBalanceGrid(){
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/statement/showTotalTrialBalance",
                data: {
        ...
        function doClosing() {
            ...
            if(find) {
                ...
                $.ajax({
                    type: "GET",
                    url: "${pageContext.request.contextPath}/statement/doClosing",
                    data: {
        ...
        function cancelClosing() {
            ...
            if(find) {
                ...
                $.ajax({
                    type: "GET",
                    url: "${pageContext.request.contextPath}/statement/cancelClosing",
                    data: {
                        "accountPeriodNo": accountPeriodNo,
        ...
        // PDF로 보기
        function createPdf() {
            window.open("${pageContext.request.contextPath}/base/report.html?method=totalTrialBalancePdf");
        }
        // Excel다운로드
        function createExcel() {
            ...
            $.ajax({
                type: "POST",
                url : "${pageContext.request.contextPath}/statement/getExcel",
                data : {
                ...
                success: function (jsonObj) {
                    ...
                    gridOptions3.api.forEachNode(function (node, index) {
                        if (index = gridOptions3.api.getLastDisplayedRow()) {
                            ...
                            accountPeriodNo = node.data.accountPeriodNo;//기수번호
                        }
                    });
                }
            });
...
<div class="row headerLine">
    <div class="row leftBox">
        ...
        <input type="button" id="getExcel" value="Excel" class="btn btn-Light shadow-sm btnsize3" style="margin-left:2px;">
    </div>
