...
<style>
  ...
  $(document).ready(function () {
    ...
    var gridOptions;
      function createIncomeStatementGrid() {
        ...
        var columnDefs = [
           ...
           marryChildren: true,
           children: [
             { headerName:'세부금액', field: 'earlyIncome', colId: '전기' , width:150,valueFormatter:currencyFormatter },
             { headerName:'합계금액', field: 'earlyIncomeSummary', colId: '전기' , width:150, valueFormatter:currencyFormatter },
           ]
           },
           {
            headerName: '당기',
            ...
            marryChildren: true,
            children: [
            { headerName:'세부금액', field: 'income', colId: '당기' , width:150, valueFormatter:currencyFormatter},
            { headerName:'합계금액', field: 'incomeSummary', colId: '당기' , width:150, valueFormatter:currencyFormatter},
            ]
          },
        ];        
        gridOptions = {
   ...
   function showIncomeStatementGrid(){
	   ...
	   $.ajax({
           type: "GET",
           url: "${pageContext.request.contextPath}/statement/incomeStatement",
           data: {
