...
<style>
  ...
  $(document).ready(function () {
	...
	function createJournal(){
		rowData=[];
		  ...
		  gridOptions = {
				      ...
				      pagination:true, // 페이저
				      paginationPageSize:7, // 페이저에 보여줄 row의 수
	...
	function showJournal(){
		 $.ajax({
             type: "GET",
             url: "${pageContext.request.contextPath}/account/findRangedJournalList",
             data: {
                 "from": $("#from").val(),
                 "to": $("#to").val()
             },
             ...
             success: function (jsonObj) {
                 gridOptions.api.setRowData(jsonObj.journalList);
             }
         });
	}
	var gridOptions2;
    ...
    function showJournalDetail() {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function (jsonObj) {
                gridOptions2.api.setRowData(jsonObj.journalDetailList);
            }
        });
    }
  </script>
