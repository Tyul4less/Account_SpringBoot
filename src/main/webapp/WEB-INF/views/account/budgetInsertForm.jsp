...
var ApplBudget={
	...
	function orgBudget(){
		...
		$.ajax({
	        type: "POST",
	        url: "${pageContext.request.contextPath}/account/budget.do",
	        data: {
	            "method": "orgBudget",
...
function createAccountPeriod(){
 ...
 function showAccountPeriod(){
	 ...
	 $.ajax({
	        type: "GET",
	        url: "${pageContext.request.contextPath}/account/findAccountPeriodList",
	        dataType: "json",
	        async:false,
	        success: function (jsonObj) {
	        	console.log(jsonObj.accountPeriodList);
 ...
 */
 ...
 function showWorkplace(){
	 $.ajax({
	        type: "GET",
	        url: "${pageContext.request.contextPath}/hr/findDeptList",
	        dataType: "json",
	        async:false,
	        success: function (jsonObj) {
	        	console.log(jsonObj.deptList);
 ...
 function showDepartment(workplaceCode){
	 $.ajax({
	        type: "GET",
	        url: "${pageContext.request.contextPath}/hr/findDetailDeptList",
	        data: {
	        ...
	        async:false,
	        success: function (jsonObj) {
	        	console.log(jsonObj.detailDeptList);
	            gridOptions5.api.setRowData(jsonObj.detailDeptList);
	        }
	    });
 }
...
function showParentBudget(){
	...
	$.ajax({
        type: "GET",
        url: "${pageContext.request.contextPath}/account/findParentBudgetList",
        dataType: "json",
        async:false,
        success: function (jsonObj) {
        	console.log(jsonObj.parentBudgetList);
            gridOptions.api.setRowData(jsonObj.parentBudgetList);
        }
    });
...
function showDetailBudget(code){
	...
	$.ajax({
        type: "GET",
        url: "${pageContext.request.contextPath}/account/findDetailBudgetList",
        data: {
            "code": code
        },
        dataType: "json",
        async:false,
        success: function (jsonObj) {
        	console.log(jsonObj.detailBudgetList);
            gridOptions2.api.setRowData(jsonObj.detailBudgetList);
        }
    });
...
function showAppliedBudget(){
	...
	console.log(ApplBudget);
	
	console.log(JSON.stringify(ApplBudget));
	
	$.ajax({
        type: "POST",
        url: "${pageContext.request.contextPath}/account/budget.do",
        data: {
            "method": "findBudgetAppl",
